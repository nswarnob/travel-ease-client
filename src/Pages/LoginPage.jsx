     ...
     <ScaleUp> <StyledWrapper>
      <form onSubmit={handleClick}  className="form_container">
        <div className="title_container">
          ...
          <span>New Here? <Link to={'/register'} className='text-blue-500' >Register</Link> </span>
        </div>
        <br />
        <div className="input_container">
          ...
          <input placeholder="name@mail.com" required  title="Inpit title" name="email" type="email" className="input_field" id="email_field" />
        </div>
        <div className="input_container">
        ...
        <button onClick={handleForget} type='button' className='font-bold note'>Forget Password?</button>
