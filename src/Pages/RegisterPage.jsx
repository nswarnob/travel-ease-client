     ...
     <ScaleUp> <StyledWrapper>
        <form onSubmit={handleClick} className="form_container">
          ...
          <div className="input_container">
            ...
            <input placeholder="https://yourimage.com" required title="url title" name="photourl" type="link" className="input_field" id="email_field" />
          ...
          <button title="Register" type="submit" required className="btn bg-primary text-white">
            <span >Register</span>
          </button>
