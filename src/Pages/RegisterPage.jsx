...
const RegisterPage = () => {
  ...
  const handleClick = async (e) => {
    ...
    if (!passwordRegex.test(password)) {
      return toast.error("Password must be at least 6 chars long and include uppercase, lowercase, and a number.");
    }
    try {
      ...
      <ScaleUp> <StyledWrapper>
        <form onSubmit={handleClick} className="form_container">
          ...
          <div className="input_container">
            ...
            <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" required className="input_field" id="email_field" />
          ...
          <div className="input_container">
            ...
            <input placeholder="Your Name" required title="name title" name="Name" type="text" className="input_field" id="name_field" />
          ...
          <div className="input_container">
            ...
            <input placeholder="https://yourimage.com" required title="url title" name="photoURL" type="url" className="input_field" id="photo_field" />
          ...
          <button onClick={handleGoogleRegister} title="Sign In" type="button" className="sign-in_ggl">
